...
- Quyền sở hữu: Mỗi folder hay file bất ký đều chịu sự quản lý của 4 đối tượng:
  ...
  - Đối tượng g: group mà file/folder đó thuộc về (những user trong nhóm này sẽ có quyền truy cập như nhau)
...
- Lệnh chgrp: chgrp +[options] + [tên nhóm sở hữu] + [tên tập tin/thư mục]. (-R thay đổi chủ sở hữu của thư mục và tất cả các tệp/thư mục con)
