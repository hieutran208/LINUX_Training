...
- Mã đại diện: 0
- Mô tả : stdin là kênh tiếp nhận dữ liệu đầu vào (từ bàn phím hoặc từ một nguồn khác). *Cách hoạt động khi sử dụng stdin để nhận dữ liệu đầu vào:*
  - Khi một chương trình chạy, nếu cần dữ liệu đầu vào thì nó sẽ yêu cầu dữ liệu đầu vào từ stdin
...
- Mã đại diện: 1
- Mô tả : stdout là kênh xuất dữ liệu của chương trình đến đích, điểm đích của dữ liệu xuất ra qua stdout có thể là màn hình, tệp, hoặc các chương trình khác:
