...
- Tầng Biểu diễn (Presentation Layer): Là tầng kế tiếp tầng biểu diễn, giúp dịch dữ liệu sang định dạng chung hoặc định dạng tầng ứng dụng có thể sử dụng:
...
- Tầng Phiên (Session Layer): Đóng vai trò thiết lập, duy trì và kết thúc giao tiếp giữa 2 máy tính
