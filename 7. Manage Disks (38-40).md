...
- Cách hoạt động: Dữ liệu được phân bổ đều trên các ổ đĩa, nhưng có thêm Parity (dữ liệu kiểm tra) được tính toán và phân phối đồng đều qua các ổ đĩa. Parity giúp khôi phục dữ liệu nếu một ổ đĩa bị hỏng. Nếu một ổ đĩa trong mảng RAID 5 bị hỏng, dữ liệu có thể được khôi phục nhờ vào thông tin parity và các ổ đĩa còn lại.
