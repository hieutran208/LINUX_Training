...
- Cách hoạt động: Dữ liệu được chia thành các khối và ghi xen kẽ các khối đó lên các ổ đĩa trong mảng. Nếu có 1 ổ đĩa gặp sự cố thì tất cả dữ liệu trong mảng sẽ mất
- VÍ DỤ:

  ![image](https://github.com/user-attachments/assets/22977a7d-7450-4caa-867d-76667da919c7)

  ![image](https://github.com/user-attachments/assets/2232c1f8-e12a-477f-98a1-a309d4ae0eea)
