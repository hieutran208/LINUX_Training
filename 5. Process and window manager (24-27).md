...
- Load Average (trung bình tải) **là tỷ lệ số lượng tiến trình đang chờ đợi hoặc đang sử dụng CPU** cho thấy trung bình có bao nhiều process mà server phải thực hiện trong một khoảng thời gian nhất định. Khi sử dụng câu lệnh top/htop để theo dõi tiến trình, load average được hiển thị dưới dạng 3 số liên tiếp nhau, biểu thị tải trong lần lượt 1, 5 và 15 phút vừa qua
- Ý nghĩa thông số:
