...
- Giữ lại phiên làm việc khi bị ngắt kết nối:
  ...
  - Khi kết nối lại vào máy chủ, chỉ cần kết nối lại vào phiên làm việc đã lưu trước đó để tiếp tục công việc. Điều này giúp tránh mất dữ liệu và gián đoạn công việc, đặc biệt là khi đang chạy các tiến trình dài hạn.
