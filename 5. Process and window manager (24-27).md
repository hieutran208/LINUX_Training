...
- Load Average (trung bình tải): thể hiện **trung bình số process mà server phải thực hiện trong một khoảng thời gian**. Khi sử dụng câu lệnh top/htop để theo dõi tiến trình, load average được hiển thị dưới dạng 3 số liên tiếp nhau, biểu thị tải trong lần lượt 1, 5 và 15 phút vừa qua
- Ý nghĩa thông số:
