...
- Quản lý nhiều phiên trong một terminal dễ dàng hơn, giúp chuyển đổi qua lại giữa các tác vụ nhanh chóng.
- Phiên làm việc được lưu lại ngay cả khi ngắt kết nối (đặc biệt hữu ích khi làm việc qua SSH).
