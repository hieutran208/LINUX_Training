...
a. File System: Hệ thống tệp là một cấu trúc mà hệ điều hành sử dụng để lưu trữ và quản lý dữ liệu trên các thiết bị lưu trữ (ổ cứng, SSD, hoặc các thiết bị lưu trữ ngoài)
