...
a. File System: Hệ thống tệp là một cấu trúc dữ liệu mà hệ điều hành sử dụng để lưu trữ, quản lý cách tổ chức và truy xuất dữ liệu trên các thiết bị lưu trữ (ổ cứng, SSD, hoặc các thiết bị lưu trữ ngoài)
