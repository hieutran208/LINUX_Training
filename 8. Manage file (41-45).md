...
- /usr
  - Mục đích: Chứa các phần mềm và dữ liệu ứng dụng được cài đặt thêm để phục vụ nhu cầu của người dùng. Đây là các ứng dụng mà người dùng có thể sử dụng sau khi đã cài đặt thêm vào hệ thống (các phần mềm như trình duyệt, bộ công cụ văn phòng, các phần mềm lập trình,....)
