...
- *RAID:*
  ...
  - RAID 1:
    ...
    - Đọc dữ liệu: Các khối dữ liệu có thể được truy xuất từ bất kì ổ đĩa nào trong mảng mà không cần phụ thuộc vào 1 ổ đĩa duy nhất nên hiệu suất đọc sẽ cao hơn đĩa đơn vì hệ thống có thể lựa chọn đọc từ ổ đĩa nào có sẵn và nhanh chóng và "chia tải" giữa các ổ đĩa khi thực hiện các yêu cầu đọc.
