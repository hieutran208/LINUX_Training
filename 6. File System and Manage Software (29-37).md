...
c. So sánh df và du
- df: Cung cấp thông tin về dung lượng của các phân vùng trong hệ thống, giúp có cái nhìn tổng quan về dung lượng đĩa
- du: Cung cấp thông tin về dung lượng của một file/thư mục cụ thể, giúp có cái nhìn chi tiết dung lượng của một thư mục/tệp cụ thể.
