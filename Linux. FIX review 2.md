...
- Filesystem
  - ext4: Là loại filesystem đáp ứng hầu hết các nhu cầu thông thường, thích hợp cho máy tính cá nhân hay máy chủ vừa và nhỏ
  - xfs: Là loại filesystem dành cho các tệp lớn, cần khả năng truy xuất nhanh, thích hợp với máy chủ lớn hay các ứng dụng nặng
